...
const COPY_BY_LANGUAGE = {
    'zh-CN': {
        subject: '登录 Flow Studio',
        preheader: '点击按钮即可继续登录。',
        title: '登录 Flow Studio',
        lead: '点击下面的按钮，继续同步你的项目、命令和写作内容。',
        button: '继续登录',
        fallback: '如果按钮无法打开，请复制下面的链接到浏览器中：',
        ignore: '如果这不是你本人操作，直接忽略这封邮件即可。',
        footer: '这封邮件由 Flow Studio 安全发送。',
    },
    en: {
        subject: 'Sign in to Flow Studio',
        preheader: 'Use the button below to continue signing in.',
        title: 'Sign in to Flow Studio',
        lead: 'Use the button below to continue syncing your projects, commands, and writing workspace.',
        ...
        footer: 'This email was securely sent by Flow Studio.',
    },
    ja: {
        subject: 'Flow Studio にログイン',
        preheader: '下のボタンからログインを続けてください。',
        title: 'Flow Studio にログイン',
        lead: '下のボタンから、プロジェクトや執筆ワークスペースの同期を続けてください。',
        button: 'ログインを続ける',
        fallback: 'ボタンが開かない場合は、次のリンクをブラウザに貼り付けてください。',
        ignore: 'このメールに心当たりがない場合は、そのまま無視してください。',
        footer: 'このメールは Flow Studio から安全に送信されました。',
    },
    ko: {
        subject: 'Flow Studio 로그인',
        preheader: '아래 버튼으로 로그인을 계속하세요.',
        title: 'Flow Studio 로그인',
        lead: '아래 버튼을 눌러 프로젝트와 작업 공간 동기화를 계속하세요.',
        button: '로그인 계속하기',
        fallback: '버튼이 열리지 않으면 아래 링크를 브라우저에 붙여 넣으세요.',
        ignore: '직접 요청하지 않았다면 이 메일은 무시해도 됩니다.',
        footer: '이 메일은 Flow Studio에서 안전하게 발송되었습니다.',
    },
};
...
<html lang="${resolvedLanguage}">
  ...
  <body style="margin:0;padding:0;background:#eef2ff;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#111827;">
    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#eef2ff;padding:24px 12px;">
      <tr>
        <td align="center">
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border-radius:20px;overflow:hidden;border:1px solid #dbeafe;">
            <tr>
              <td style="padding:28px 28px 20px;background:linear-gradient(135deg,#111827 0%,#2563eb 60%,#7c3aed 100%);color:#ffffff;">
                <div style="font-size:13px;letter-spacing:0.12em;text-transform:uppercase;opacity:0.78;">Flow Studio</div>
            ...
            <tr>
              <td style="padding:28px;">
                ...
                <p style="margin:0 0 24px;font-size:13px;line-height:1.7;word-break:break-all;"><a href="${safeLink}" style="color:#2563eb;text-decoration:underline;">${safeLink}</a></p>
