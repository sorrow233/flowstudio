    ...
    return (
        <div className="max-w-7xl mx-auto pt-10 px-6 pb-24">
            ...
            <div className="mb-12 flex justify-between items-end border-b border-gray-100 pb-8">
                <div>
                    ...
                    <p className="text-gray-400 text-sm font-light tracking-wide max-w-xl leading-relaxed">
                        Design the economic engine of your application. Price your value, choose your rails, and plan your growth.
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                {/* Left Column: Revenue & Infrastructure (2/3) */}
                <div className="lg:col-span-2 space-y-12">
                    ...
                    {/* 3. Financial Infrastructure (New) */}
                    <section>
                        <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-6 flex items-center gap-2">
                            <Wallet size={16} /> Financial Infrastructure
                        </h3>
                ...
                {/* Right Column: Growth & Launch (1/3) */}
                <div className="space-y-10">

                    {/* 4. Growth Engine (New) */}
                    <section>
                        <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-6 flex items-center gap-2">
                            <Megaphone size={16} /> Growth Engine
                        </h3>
                        <div className="bg-white border border-gray-100 rounded-[2rem] p-6 shadow-sm">
                            <p className="text-xs text-gray-400 mb-4 px-1">Select active marketing channels for launch:</p>
                                        ...
                                        <button
                                            ...
                                            className={`
                                                ...
                                                ${isActive
                                                    ...
                                                    : 'bg-gray-50/50 border-transparent hover:bg-white hover:border-gray-200 text-gray-500'}
                                            `}
                                        >
                                            <div className="flex items-center gap-3">
                                                <channel.icon size={16} className={isActive ? 'text-amber-600' : 'text-gray-400'} />
                                                <span className="text-sm font-medium">{channel.title}</span>
                                            </div>
                                            {isActive && <Check size={14} className="text-amber-600" />}
                                        </button>
                                    );
                                })}
                            </div>
