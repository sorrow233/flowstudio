                ...
                <div className="flex gap-2">
                    {isEditing ? (
                        <>
                            ...
                            <button onClick={onSaveEdit} className="flex items-center gap-2 px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl backdrop-blur-md transition-colors text-xs font-medium shadow-lg shadow-emerald-500/20">                            <button onClick={onSaveEdit} className="px-4 py-2 bg-purple-500 hover:bg-purple-400 text-white rounded-xl shadow-lg transition-colors flex items-center gap-2 text-xs font-bold uppercase tracking-wider">
                                <Save size={14} /> Save
                            </button>
                            </>
                            ) : (
