...
const TaskList = ({ tasks, projectId, activeStage, onToggle, onDelete, onAddTask, newTaskInput, setNewTaskInput, newTaskCategory, setNewTaskCategory, onScroll }) => {
    ...
    return (
        <div className="flex-1 flex flex-col h-full overflow-hidden relative">
                ...
                <AnimatePresence mode="popLayout">
                    {visibleTasks.length > 0 ? (
                        ...
                        <motion.div
                            ...
                            className="flex flex-col items-center justify-center h-full min-h-[300px] text-center p-8 opacity-60"
                        >
            ...
            {/* Input Footer */}
            <div className="p-8 pt-4 bg-white/90 backdrop-blur-md shrink-0 border-t border-gray-100/50">
