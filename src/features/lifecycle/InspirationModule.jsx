    ...
    return (
        <div className="max-w-4xl mx-auto pt-14 px-6 md:px-10 pb-32">
            ...
            <div className="relative mb-20 group">
                <Spotlight className="rounded-2xl" spotColor="rgba(244, 114, 182, 0.12)">
