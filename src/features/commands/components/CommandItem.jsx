...
const CommandItem = ({
    ...
    return (
        <Reorder.Item
            value={cmd}
            dragListener={!isSelectionMode && !isSearching}
            ...
            <div className="relative">
                ...
                <motion.div
                    ...
                    className={`
                        ...
                        ${isGrabbing ? 'cursor-grabbing ring-1 ring-rose-100 shadow-lg' : ''}
                    `}
                >
                    <div className="flex items-center gap-4 z-10">
                        ...
                        {isSelectionMode ? (
                            ...
                            <div
                                ...
                                className="cursor-grab active:cursor-grabbing text-gray-300 hover:text-gray-400 p-2 -ml-2 touch-none"
                            >
