...
const Navbar = () => {
    ...
    const isWritingPath = location.pathname.startsWith('/writing');

    return (
        <div className={`relative z-50 w-full justify-center px-3 pb-3 pt-4 md:px-4 md:pb-4 md:pt-10 ${isWritingPath ? 'hidden md:flex' : 'flex'}`}>
